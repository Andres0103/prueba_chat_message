#Importante: Este archivo define el modelo de base de datos para mensajes utilizando SQLAlchemy.
...
class MessageModel(Base):
    ...
    # Campos básicos del mensaje (según instrucciones en el documento)
